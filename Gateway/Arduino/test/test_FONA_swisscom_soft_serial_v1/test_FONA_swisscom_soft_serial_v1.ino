...
// SoftSerial for debugging

SoftwareSerial debugSerial = SoftwareSerial(10, 11); 
void setup() {

  debugSerial.begin(9600);
  debugSerial.println("debugSerial initialized.");
  while (!Serial);
...
fona.setGPRSNetworkSettings(F("gprs.swisscom.ch"), F("gprs"), F("gprs"));
...
void loop() {
  debugSerial.println("Start of loop.");
  Serial.print(F("FONA> "));
