...
void setup() 
{
  ...
  //rtc.autoTime(); // Did not work on 29.08.2018 18:30
                  ...
                  // Did work on     01.02.2019 13:04
                  // Did work on     18.02.2019 09:49
                  // Did work on     18.02.2019 10:37 (date worked, time didn't
  // Or you can use the rtc.setTime(s, m, h, day, date, month, year)
  // function to explicitly set the time:
  // e.g. 7:32:16 | Monday October 31, 2016:
   rtc.setTime(00, 38, 10, 2, 18, 02, 19);  // Uncomment to manually set time (does work)
